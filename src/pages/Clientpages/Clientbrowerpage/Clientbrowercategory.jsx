...
<div>
  ...
  <div style={{fontSize:20}}>Mani</div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginTop: "10px" }}>
            ...
            <div style={{ marginLeft: 12 }}>
              <h1 style={styles.title}>Browse Project</h1>
              <p style={{ fontWeight: "400", size: "24px", marginLeft: screen === "SUB" ? "50px" : "-5px", marginTop: "40px" }}>
                What Are You Looking For?
              </p>
              <p style={{ color: "#0A0A0A", marginLeft: "-37px", fontSize: "16px", fontWeight: "400" ,marginLeft: screen === "SUB" ? "50px" : "-5px",}}>Choose your a category</p>
            </div>
          </div>
